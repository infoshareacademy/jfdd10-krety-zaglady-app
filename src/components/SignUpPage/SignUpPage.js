...
const dictionary = {
  ...
  'auth/weak-password': "Hasło powinno mieć 6 lub więcej znaków."
...
class SignUpPage extends Component {
  state = {
    ...
    description: "",
    image:
      "https://cdn3.iconfinder.com/data/icons/avatar-55/64/Scientist-avatar-occupation-profession-man-human-512.png",
    error: null
  };
    ...
    return (
      <div className="SignUpPage">
        <form onSubmit={this.handleSubmit} className="SignUpForm">
          ...
          <div>
            <button id="register" className="register">
              Wyślij
            </button>

            <img src="/data/signmole.png" alt="sign" className="Sign-drawing" />
          </div>
        </form>
      </div>
    );
